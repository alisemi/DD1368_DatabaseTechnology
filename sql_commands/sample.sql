...
VALUES 
("Lenore","DTN33UAZ8KD","Ivan","Moran","worker",1),
("Madonna","PYL63HXW6JU","John, Sylvester","Dorsey","worker",1),
("Christen","EOX00TTO6TJ","Ayanna, Hedda","Hicks","leader",1),
("Jasper","SAE50BQH1FQ","Willa, Blaze","Workman","worker",1),
("Jillian","GZL03JER0OB","David, Autumn","Knapp","president",1),
("Rahim","KOZ58JYW0QV","Cheryl, Lenore","Salas","worker",1),
("Angela","GIZ49IIC8TO","Nora, Oprah","Suarez","worker",1),
("Regan","SVJ59PFY3SF","Quinn, Phelan","Cash","leader",1),
("Robin","KRX74UHT2VW","Clarke, Reece","Whitaker","vc.president",1),
("Isaiah","XJV34EKN5VL","Abel, Grady","Snow","worker",1),
("Salvador","JQJ99ILL5ZN","Noble, Emmanuel","Oneil","worker",1),
("Jayme","ADX50APF9QS","Regina, Camille","Freeman","worker",1),
("Finn", "CVE72YYC0DN",     "Amela, Ray", "Fuller","leader",1),
("Lacota","EUI09FHV9JI","Irma, Nero","Kim","worker",1),
("Norman","HRJ83MCW7YD","Talon, Ivor","Hoffman","worker",1),
("Macon","DOP88TEG2WG","Hermione, Kristen","Tanner","worker",1),
("Acton","GEJ67LIN4NE","Maryam, Emi","Rich","worker",1),
("Kitra","JAQ47QKZ1YR","Ferdinand, Damon","Ware","worker",1),
("Edan","JSF35EDU7YT","Alana, Emerald","Key","worker",1),
("Chancellor","WDV65SCV9WR","Cherokee, Cadman","Dillon","leader",1),
("Juliet","SHF82XEY5YD","Eleanor","Santos","Mauris",1),
("Griffith","ZFT15WWC6WN","Reece, Logan","Tate","Volutpat",1),
("Whoopi","ATN44CXK3DZ","Hu, Phelan","Jensen","Institute",1),
("Alo", "HRJ93MAB7EH","Rashad, Laura","Harrington",   "Massa",1),
("Alo2","XHP50OSL8PS", "Noah, Aquila",   "Delgado","Pharetra",1),
("Alo3","NMI85AWR9BP","Robin, Marvin","Gates","Foundation",1),
("Alo4","VVQ03JGP0ZS","Carter, Brielle","Heath","Nec",1),
("Alo5","QVL01ZRA8XS","Allistair, Curran","Thompson","Corp",1),
("Alo6","UEF94TUF4VN","Dylan, Thomas","Levine","Blandit Corporation",1),
("Alo7","UEF94TUF4V4","Problem","Alma","Alma Corp",1);
